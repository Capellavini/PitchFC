...
- Tens de ter pelo menos [13/16] anos para criar uma conta. [A confirmar — ver nota sobre menores na Política de Privacidade.]
- Podemos suspender ou eliminar contas que violem estes termos.

## 4. As tuas responsabilidades

Ao usar o PITCH, compromete-te a:
...
## 5. Conteúdo que publicas

Ao publicar fotos, vídeos ou comentários no PITCH, mantés os direitos sobre esse conteúdo, mas dás-nos uma licença para o mostrar dentro da app, aos outros membros dos teus grupos (ou publicamente, no caso do feed entre grupos). És responsável pelo que publicas.

## 6. Pagamentos entre jogadores
