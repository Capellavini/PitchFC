...
> ⚠️ **Rascunho de trabalho.** Escrito pelo Leo (CMO/IA) a pedido do Vinicius, adaptado ao que o PITCH recolhe de verdade hoje. Não é aconselhamento jurídico — antes de publicar, revê os campos entre `[colchetes]` e, idealmente, passa por um advogado, sobretudo antes de qualquer integração de pagamento real (MB Way).
...
- **Dados técnicos:** idioma escolhido, preferências guardadas no teu dispositivo (localStorage), e dados de utilização básicos da app.
...
- Enviar lembretes e notificações sobre o teu jogo (incluindo via WhatsApp, quando aplicável — [nome do bot, ex: Pitch AI])
...
O PITCH pode ser usado por menores de 18 anos, no contexto de grupos de futebol amador. [Definir aqui a idade mínima e se é exigido consentimento parental — a rever com atenção, já que há jogadores adolescentes em grupos reais.]
